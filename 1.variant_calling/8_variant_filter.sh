...
#step3: keep 25 contigs (18 autosome + 7 X contigs) and remove sites located in repetitive region
...
#step4: keep 25 contigs (18 autosome + 7 X contigs) and remove sites located in repetitive region
